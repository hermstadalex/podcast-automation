...
export class GeminiService {
    ...
    async generateShowNotes(audioFilePath: string): Promise<ShowNotes> {
        ...
        const result = await model.generateContent([
            ...
            "1. title: A catchy, viral-worthy, SEO-optimized title for YouTube.\n" +
            "2. summary: A compelling 2-3 paragraph podcast show notes summary.\n" +
            "3. timestamps: An array of 5-7 key timestamps in 'MM:SS - Description' format.\n" +
            "4. hashtags: A single string of 3-5 trending, highly relevant hashtags with spaces (e.g. '#business #growth #startup').\n" +
            "5. keywords: A comma-separated string of 10 long-tail SEO keywords targeted for YouTube search.\n" +
            "6. squareArtPrompt: A highly-detailed, visually descriptive prompt designed for an AI image generator to create centered, bold, minimalist 1:1 Podcast Cover art. Emphasize visual subjects, branding, and color palette.\n" +
            "7. landscapeThumbPrompt: A completely distinct prompt designed for a YouTube 16:9 thumbnail. Emphasize 'MrBeast-style' high-contrast lighting, a central dramatic focal point (e.g. human face reaction), saturated colors, and negative space for text.\n" +
